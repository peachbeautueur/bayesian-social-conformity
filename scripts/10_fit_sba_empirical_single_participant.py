...
def main() -> None:
    """Fit the SBA Stan model to one empirical participant."""
    ...
    posterior_summary_path = results_dir / "sba_empirical_single_participant_summary.csv"
    full_summary_path = results_dir / "sba_empirical_single_participant_full_summary.csv"
    ...
    print("\n" + "=" * 80)
    print("Posterior summary for empirical SBA single-participant fit")
    print("=" * 80)
