"""Fit the Stan WBA model to synthetic SBA-generated data.

This script loads the synthetic SBA dataset, prepares Stan inputs, fits the
existing lecture-inspired Weighted Bayesian Agent model with cmdstanpy, and
saves basic fit outputs for later model-recovery comparisons.

Run from the project root:
    python scripts/06_fit_wba_to_sba_synthetic.py
"""
...
def main() -> None:
    """Fit the WBA Stan model to the synthetic SBA data."""
    ...
    posterior_summary_path = results_dir / "wba_on_sba_synthetic_posterior_summary.csv"
    full_summary_path = results_dir / "wba_on_sba_synthetic_full_summary.csv"
    ...
    print("\n" + "=" * 80)
    print("Posterior summary for WBA fit on SBA synthetic data")
    print("=" * 80)
